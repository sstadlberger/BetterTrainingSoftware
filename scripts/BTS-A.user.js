...
(function() {
    ...
    function parseDays () {
        ...
        for (var training of document.getElementsByClassName('next-training-block')) {
            ...
            for (var step of training.children) {
                trainingData.workouts = getWorkoutsPerDay(step, trainings.length);
            }
     ...
     * @param {HTMLCollection} step - a child of a 'next-training-block'
     ...
     */
    function getWorkoutsPerDay (step, day) {
